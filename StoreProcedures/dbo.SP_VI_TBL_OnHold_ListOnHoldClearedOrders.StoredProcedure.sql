...
GO
/****** Object:  StoredProcedure [dbo].[SP_VI_TBL_OnHold_ListOnHoldClearedOrders]    Script Date: 4/29/2026 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
-- Author:              <Nam Nguyen>
-- Create date: <29 Apr, 2026>
-- Description: <List Orders and Fulfilments with FulfilmentStatus = OnHoldCleared with search and paging>
-- =============================================
ALTER PROCEDURE [dbo].[SP_VI_TBL_OnHold_ListOnHoldClearedOrders]
...
BEGIN
    ...
    (
        ...
        WHERE ISNULL(o.Deleted, 0) = 0
          AND o.FulfilmentStatus = 'OnHoldCleared'
